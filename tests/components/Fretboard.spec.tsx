...
describe('Fretboard', () => {
  ...
  describe('Props - rootNote', () => {
    ...
    it('handles invalid root note gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Invalid note name'));
  ...
  describe('Props - orientation', () => {
    ...
    it('applies vertical orientation', () => {
      const { container } = render(
        <Fretboard viewMode="scale" rootNote="G" orientation="vertical" />
      );
  ...
  describe('Props - highlightedNotes', () => {
    it('highlights specified notes in notes mode', () => {
      const { container } = render(
        <Fretboard viewMode="notes" highlightedNotes={[0, 4, 7]} showLabels={true} />
      );
  ...
  describe('Props - selectedPosition', () => {
    it('marks selected position with selected class', () => {
      const { container } = render(
        <Fretboard viewMode="scale" rootNote="A" selectedPosition={{ string: 5, fret: 5 }} />
      );
  ...
  describe('Interactivity', () => {
    it('calls onNoteClick when a note is clicked', async () => {
      ...
      render(
        <Fretboard viewMode="scale" rootNote="E" onNoteClick={handleClick} interactive={true} />
      );
    ...
    it('does not call onNoteClick when interactive is false', async () => {
      ...
      render(
        <Fretboard viewMode="scale" rootNote="E" onNoteClick={handleClick} interactive={false} />
      );
  ...
  describe('Custom tuning', () => {
    it('accepts custom tuning array', () => {
      ...
      render(<Fretboard viewMode="scale" rootNote="D" tuning={dropD} />);
