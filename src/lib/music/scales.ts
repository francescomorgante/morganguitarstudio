...
export const SCALE_TYPES: Record<string, ScaleType> = {
  minor: { name: "Pentatonica minore", intervals: [0,3,5,7,10], degrees: ["1","♭3","4","5","♭7"] },
  major: { name: "Pentatonica maggiore", intervals: [0,2,4,7,9], degrees: ["1","2","3","5","6"] },
  majorFull: { name: "Scala maggiore", intervals: [0,2,4,5,7,9,11], degrees: ["1","2","3","4","5","6","7"] },
  minorNatural: { name: "Scala minore naturale", intervals: [0,2,3,5,7,8,10], degrees: ["1","2","♭3","4","5","♭6","♭7"] }
};
